...
def unlock():
    ...
    if check_password_hash(expiration_key.key.data,exp_hash,exp_salt) == True:
...
def change_svradmpw():
        ...
        if request.method == "POST" and credentials_pass.validate():
            ...
            if password == confirm_passwd:
                ...
                input_password_hash = generate_password_hash(current_username+password, salt)
